const commands = [
  ...
  },
  {
    ...
    description:
      'Adds a description that people will see when they look at you. The description is shown in the form of "your name + text". For example, if I type "describe is a Borg.", then my description will read "Descartes is a Borg.". If no argument is given, then your description disappears. See also: review, message, title, pretitle',
  },
  {
    id: 'dismount',
    name: 'dismount',
  ...
  },
  {
    id: 'get',
    name: 'get',
    syntax: 'get <item | all | every item> [from <container>]',
    description:
  ...
  },
  {
    ...
    name: 'rest',
    syntax: 'rest',
    description: 'Someone who is resting will regain their lost health. See also: sleep, wake',
  },
  {
    id: 'restartheart',
    name: 'restartheart',
  ...
  },
  {
    ...
    syntax: 'sleep',
    description:
      'Someone who is sleeping will regain their lost health at a far quicker rate than if they were simply awake. The exact rate at which they will rejuvenate is dependant upon their constitution. To awaken from a slumber, simply type <wake>; and while in a slumber, you are unable to perform any actions, other than awakening. See also: rest, wake',
  },
  {
    id: 'songs',
    name: 'songs',
  ...
  },
  {
    ...
    description:
      "List all of the available spells for the given argument. Use 'healermonk' or 'healermage' to clarify which healer subclass to query. See also: abilities, abilities2",
  },
  {
    id: 'start',
    name: 'start',
  ...
  },
  {
    ...
    syntax: 'wimpy [number]',
    description:
      'When on, wimpy will automatically flee you from combat when your hitpoints are reduced below [number]% of your total. The number should be between 0 and 50. Hardcore maxes at 10. See also: wimpydir',
  },
  {
    id: 'wimpydir',
    name: 'wimpydir',
  ...
  },
  {
    ...
    syntax: 'review',
    description:
      'Displays the messages other players see when you enter, or exit a room. Also shows your title and pretitle. See also: message',
  },
  {
    id: 'message',
    name: 'message',
    syntax: 'message in|out [message]',
    description: 'Updates your enter/exit messages. $D provides direction.',
  },
  {
    id: 'arealist',
    name: 'arealist',
    syntax: 'arealist [filter]',
    description:
      'List out all the areas, sub-areas, and zones in the game world and the associated target level ranges.If an optional filter is provided, will display only the zones that match the area, sub- area, or zone name, or level range. Valid level ranges are newbie, mid, hm, elite, legend, or titan.',
  },
  {
    id: 'cooldowns',
    name: 'cooldowns',
    syntax: 'cooldowns',
    description: 'This command will show you any cooldowns that are you subject to.',
  },
  {
    id: 'nickname',
    name: 'nickname',
    syntax: 'nickname, nickname <word>, nickname <word> <command>, nickname <word> <command> $*',
    description:
      "Nicknames are short words for names.  Almost like an alias but a nicknames can be part of commands instead of the whole command.  For example, take the name 'Petrarch'.  That is a long name, but you can 'nickname pett Petrarch' then type 'say Hello pett' and you will actully say 'Hello Petrarch'. To see the complete list of your nicknames type 'nickname'. See also: unnickname, alias, unalias",
  },
  {
    id: 'unnickname',
    name: 'unnickname',
    syntax: 'unnickname <word>',
    description: 'Unnickname removes a nickname which you no longer need or want. See also: nickname, alias, unalias',
  },
  {
    id: 'title',
    name: 'title',
    syntax: 'title off|[new title]',
    description:
      'Changes your title that comes after your name. Only available to High Mortals. Using off will clear your current title. Placing anything offensive in your title is grounds for immediate removal from the game. See also: pretitle',
  },
  {
    id: 'pretitle',
    name: 'pretitle',
    syntax: 'pretitle',
    description:
      "Allows a member of a kingdom to display their kingdom rank in front of their title. Pretitles can only be removed by the use of the 'title' command. Only HMs have the 'title' command. Pretitles are cleared after every level, or when the title command is used. See also: title.",
  },
  {
    id: 'wake',
    name: 'wake',
